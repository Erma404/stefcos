...
import { buildWhatsAppProductUrl, formatPrice } from "@/lib/whatsapp";
  ...
  return (
    <div className="group">
      ...
      <a
        ...
        className="mt-3 w-full flex items-center justify-center gap-2 bg-[#25D366] text-primary-foreground font-sans text-[10px] font-semibold tracking-widest uppercase py-2.5 rounded-sm hover:bg-[#1da851] transition-colors"
      >
